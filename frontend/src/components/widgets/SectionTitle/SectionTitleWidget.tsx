...
import type { SectionTitleWidget as SectionTitleType } from '../../../lib/types';
import { cn } from '../../../lib/utils';

interface Props {
    widget: SectionTitleType;
    isSelected: boolean;
    onSelect: () => void;
    onDelete: () => void;
}

export function SectionTitleWidget({ widget, isSelected, onSelect, onDelete }: Props) {
    return (
        <div
            className={cn(
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <span className="text-sm text-gray-500 truncate block">{widget.data.title}</span>
            </div>
